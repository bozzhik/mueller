...
const euroclearData = {
  ...
  advantages: ['Наличие в команде бельгийского  адвоката, имеющего большой  опыт в разблокировке активов', 'Комплексная поддержка адвокатов из Бельгии и РФ: подготовка, рассмотрение и исполнение заявки по выводу активов из РФ в ЕС за фиксированную цену', 'Возможность оплаты на российский счёт в рублях'],
