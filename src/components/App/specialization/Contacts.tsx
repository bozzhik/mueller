      ...
      <div className={cn('grid grid-cols-2 py-10 px-7 sm:grid-cols-1 sm:gap-6 sm:px-3 xl:py-8 sm:pb-10', className)}>
        <div className="flex flex-col justify-between sm:gap-2.5">
          ...
          <div className="space-y-2 sm:space-y-7">
            ...
            <H4 className="max-w-[50ch] !leading-[1.3]">Ваши ответы помогут нам тщательнее подготовиться к звонку и сэкономить Ваше время. Полученная информация охраняется адвокатской тайной и не будет передана третьим лицам. После получения заявки мы свяжемся с Вами.</H4>
          </div>
        </div>
