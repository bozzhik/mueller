  ...
  return (
    <Container className="border-b border-gray">
      <div className="w-[70%] sm:w-full sm:px-3 mx-auto pb-20 space-y-8 pt-14 sm:py-10">
        ...
        <Section title="7. Контакты" content={[`Если у вас есть вопросы или жалобы, связанные с обработкой ваших данных, вы можете связаться с нами по адресу: support@yourwebsite.com`]} />
      </div>
    </Container>
  )
}
