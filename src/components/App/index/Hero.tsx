  ...
  return (
    <section data-section="hero-index" className={cn('grid grid-cols-2', blockHeight)}>
      ...
      <div className="flex flex-col justify-between pt-7">
        <P className="uppercase px-10">Адвокатская коллегия нового поколения, в которую входят европейские и российские адвокаты.</P>

        <div className="space-y-7">
          <H1 className="px-10">Мы знаем правила игры</H1>
